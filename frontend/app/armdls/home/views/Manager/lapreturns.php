...
echo form_open('apotik/laporan/repreturnstanggal',$att)
?>
<div class="control-group">
    <label class="control-label" for="inputPassword">Pilih Tanggal</label>
    <div class="controls">
    dari tanggal<input type="text" id="datepicker2"  name="tgl" placeholder="Tanggal">hingga<input type="text" id="datepicker3"  name="tgl2" placeholder="Tanggal">
    </div>
    </div>   
